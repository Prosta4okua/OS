...
void add(ArrayList list, int );
void insert(ArrayList list, int ,int );
void size(ArrayList list, );
void remove_value(ArrayList list, int ); // 'remove' method is found in stdio.h
void set(ArrayList list, int ,int );
void get(ArrayList list, int );
...
int enter_int(ArrayList list, char* msg) {
    int temp;
    printf("%s", msg);
    scanf("%d", &temp);
    return temp;
...
void remove_value(ArrayList list, int index) {
    int old_value;
...
void set(ArrayList list, int index, int item) {
    ...
    // saving the laba7 value only for logging
